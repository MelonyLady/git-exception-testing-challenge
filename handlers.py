...
def handle_index_error():
    ...
    except (IndexError, ValueError):  # can addd other errors within brackets
        print("Sorry, that wasn't one of the available options.")
